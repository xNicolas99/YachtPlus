      ...
      <v-card color="foreground" tile>
        ...
        >
          ...
          <template v-slot:item.actions="{ item }">
            <v-btn icon size="small" variant="text" class="mr-2" @click="editUser(item)" aria-label="Edit User" title="Edit User">
              <v-icon>mdi-pencil</v-icon>
            </v-btn>
            <v-btn icon size="small" variant="text" @click="deleteUser(item)" aria-label="Delete User" title="Delete User">
